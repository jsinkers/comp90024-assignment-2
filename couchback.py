...
class CouchInterface:
    ...
    def _create_view(self, database: str, design_name: str, data: str, view_name: str) -> dict:
    ...
    def _create_views(self, database: str, design_name: str, data: str, views_name: list) -> list:
        design_name = '_design/' + design_name
        requests.put(self.url + database + '/' + design_name, data=data)
        views = []
    ...
    def create_mapreduce_view(self, database: str, design_name: str, map_fun: str,
                              reduce_fun: str = None, view_name: str = 'default') -> dict:
        """
    ...
    def create_mapreduce_views(self, database: str, design_name: str, mapreduce_funcs: list, views_name: list) -> list:
        """
...
class MapGenerator:
    ...
    def set_key(self, keys: Union[str, list]) -> None:
        """
    ...
    def set_value(self, values: Union[str, list]) -> None:
        """
...
def test_historic_election_tweet():
    ...
    if ("error" in ci.get_view("twitter_historic", "tweets", "election_tweets")):  # if view not exist
        # create a new view
        ret = ci.create_regex_view_combined('twitter_historic', 'doc.tweet', election_keywords, 'tweets',
                                            'election_tweets')
